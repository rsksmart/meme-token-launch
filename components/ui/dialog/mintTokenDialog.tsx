...
import { MetamaskIcon, ErrorCircleIcon, CheckCircleIcon, CopyIcon, HelpCircleIcon } from '@/components/icons'
...
function MintTokenDialog({ closeDialog, open, address, strategy }: props) {
  ...
  return (
    ...
    <BaseDialog
      ...
      open={open}
      className={(isMinting || isError || isMinted ? "h-[350px] w-[500px]" : "h-[500px] w-[600px]") + " text-white"}
    >
      {isError || isMinted ? (
              ...
              <div className="flex flex-col w-full my-3 px-8">
                <div className="flex-row flex w-full flex gap-2 items-center">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>This is the contract address from which you will mine your tokens. You can not edit this field. </p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="flex flex-col w-full my-3 px-8">
                <div className="flex-row flex w-full flex gap-2 items-center">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Enter the address where you want to send your tokens</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <input

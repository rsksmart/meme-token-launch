...
type EnvironmentVariables = {
  FACTORY_ADDRESS_ERC20: string
  FACTORY_ADDRESS_ERC1155: string
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const FACTORY_ADDRESS_ERC20 = process.env.NEXT_PUBLIC_FACTORY_ADDRESS_ERC20
  const FACTORY_ADDRESS_ERC1155 = process.env.NEXT_PUBLIC_FACTORY_ADDRESS_ERC1155
